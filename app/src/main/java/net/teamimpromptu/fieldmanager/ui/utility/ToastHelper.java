...
public class ToastHelper {
    ...
    public static void show(View view, String message) {
        showSnackbar(view, message, null, null, null, null, null);
    }
    ...
    public static void showSnackbar(Context context, String message,
        ...
        showSnackbar(view, message, buttonText, listener, onDismissedCallback, duration, null);
    }
    ...
    public static void showSnackbar(View view, String message,
                                    String buttonText, View.OnClickListener listener,
                                    Snackbar.Callback onDismissedCallback, Integer duration, Integer lines) {
